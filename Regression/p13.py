...
root = Tk()
root.title("papsep2023.csv")
root.geometry("1000x600+50+50")

f = ("Arial", 25, "bold")
f1 = ("Arial", 30, "bold")

lab_header = Label(root, text = "Property Price Prediction", font = f1)
lab_header.place(x = 300, y = 50)

lab_area = Label(root, text = "Enter the area: ", font = f)
ent_area = Entry(root, font = f)
lab_area.place(x = 50, y = 120)
ent_area.place(x = 400, y = 120)
...
btn_predict.place(x = 350, y = 350)
lab_ans.place(x = 350, y = 500)
